...
When the agent asks a video call to the customer, the customer can choose to **decline the video** contact and **keep activated only the voice channel** (or decline both video and voice contact).
[block:image]
{
  "images": [
    {
